...
const CarDetail = () => {
  ...
  return (
    <Container>
      ...
      {car && (
        <main className="w-full my-auto bg-white rounded-lg p-6 my-4">
          ...
          flex items-center justify-center gap-2 my-6 h-11 text-xl rounded-lg font-medium cursor-pointer"
            href={`https://api.whatsapp.com/send?phone=${car?.whatsapp}&text=Olá vi esse ${car?.name} no site Lima veículos e fiquei interessado!`}
            target="_blank"
          >
